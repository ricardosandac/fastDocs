---
title: install-scratch.sh
summary: Script para configurar um scratch org do Salesforce em sistemas Unix para o projeto E-Bikes.
---

# install-scratch.sh

## Descrição
O script `install-scratch.sh` automatiza a configuração de um scratch org do Salesforce para o projeto E-Bikes em sistemas baseados em Unix. Ele realiza etapas como criação do scratch org, implantação do código-fonte, atribuição de permissões e importação de dados de exemplo.
